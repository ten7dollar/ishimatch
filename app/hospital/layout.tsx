...
const navItems = [
  ...
  { href: "/hospital/favorites", label: "お気に入り学生一覧" }, // ★ 追加
  { href: "/hospital/scouts", label: "スカウトステータス" }, // 追加
  { href: "/hospital/pr", label: "PRページ編集" },
  { href: "/hospital/applications", label: "応募管理" },   // ★ 追加
...
export default function HospitalLayout({ children }: { children: ReactNode }) {
  ...
  return (
    // /hospital配下全体でスカウト送付履歴・お気に入り学生が共有できるようにProviderでラップ
