...
export default function SavedHospitalsPage() {
  const { loading, list, toggle, clearAll } = useDbFavorites();
    ...
    <main className="max-w-5xl mx-auto px-8 py-6 space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {list.map((r) => {
            const h = r.hospitals; // HospitalMini
            return (
              <div key={r.hospital_id} className="border rounded-xl p-5 bg-white">
